...
#define TEMP_WARNING_ENABLE     0         // to beep or not to beep, 1 or 0, DO NOT ACTIVATE WITHOUT CALIBRATION!
...
// ########################### UART SETIINGS ############################
  ...
  #define SERIAL_BUFFER_SIZE      256 // 64                      // [bytes] Size of Serial Rx buffer. Make sure it is always larger than the structure size
